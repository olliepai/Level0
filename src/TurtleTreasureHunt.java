...
public class TurtleTreasureHunt implements KeyEventDispatcher {
	...
	private void spaceBarWasPressed() {
		...
		if(tortoiseLocationX > 490 && tortoiseLocationX < 510 && tortoiseLocationY > 295 && tortoiseLocationY < 350) {
			JOptionPane.showMessageDialog(null, "Go to the boy");
		}		
		if(tortoiseLocationX > 145 && tortoiseLocationX < 155 && tortoiseLocationY > 270 && tortoiseLocationY < 345) {
			JOptionPane.showMessageDialog(null, "Go to the water");
		}
		if(tortoiseLocationX > 65 && tortoiseLocationX < 495 && tortoiseLocationY > 385 && tortoiseLocationY < 440) {
			JOptionPane.showMessageDialog(null, "Find the tree");
		}
